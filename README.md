...
# Alle client-bezogenen Kategorien auf einmal
python3 enhance_vault.py \
  --vault ~/Obsidian/AsanaExport \
  --client-categories

# Hinweis: Dabei läuft `client_file_reorganization` zuerst, damit die Ordnerstruktur vor den anderen Client-Schritten angepasst wird.
